...
const CompetitionPage = () => {
  ...
  return (
    <>
    <AddCompetitionRoomType open={registerModal} onOk={() => setRegisterModal(false)} />
      ...
      <div className="room-type-wrap">
        <div className="room-type">
          ...
          <div className="room-type-container">
            ...
            <div className="info-section">
              <h4>어메니티 정보</h4>
              <p>소파, 가스레인지/인덕션, 스파/월풀, 착장실, 비데, 냉장고</p>
            </div>
            <div className="info-section">
              <h4>서비스 정보</h4>
              <p>취사가능, 셔틀버스, WIFI, 조식서비스</p>
            </div>
          </div>
        </div>
        <div className="room-type">
